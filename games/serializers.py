...
class GamesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Game
        fields = ("id", "title", "user_rate","release_date", "score", "hltb_normal","hltb_hard","hltb_full","description", "metacritic_link", "must_play", "genre", "platform", "company", "image", "comments")
